// src/cli.ts
import { ChessGame, P2PChessNode, convertMoveToUCI, sha256 } from 'chess-lib';
import type { ProposalMessage, FinalizedMoveMessage, HistoryRequestMessage, HistoryResponseMessage, CurrentStateMessage, MoveBlock, ChessJsVerboseMove} from 'chess-lib'
